...
Stok miktarı azalan ürünlerin yanında otomatik olarak (KRİTİK!) uyarısı tetiklenir.
Listelenen tüm ürünlerin maliyet değerlerini çarparak dinamik bir şekilde genel toplam değer hesabı yapar.
Stok listesinde  isme göre anlık arama yapabılabilir.
Çoklu Kullanıcı Desteği ile birden fazla kullanıcı, kendilerine ait benzersiz kullanıcı adı ve şifre bilgileriyle sisteme güvenli bir şekilde giriş yapabilir.
